...
public class UCTParams extends PlayerParameters {
    ...
    public boolean pUCT = true;
    public double pUCTTemperature = 0.0;
    ...
    @Override
    public UCTPlayer instantiate() {
        return new UCTPlayer((UCTParams) this.copy());
    }
