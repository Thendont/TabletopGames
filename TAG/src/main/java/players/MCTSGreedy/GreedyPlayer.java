...
public class GreedyPlayer extends AbstractPlayer {
    ...
    public GreedyPlayer(long seed) {
        super(new GreedyParams(), "Basic MCTS");
        ...
        GreedyParams params = getParameters();
    ...
    public GreedyPlayer(GreedyParams params) {
    ...
    public AbstractAction _getAction(AbstractGameState gameState, List<AbstractAction> actions) {
        ...
        GreedyTreeNode root = new GreedyTreeNode(this, null, gameState, rnd);
    ...
    @Override
    public GreedyParams getParameters() {
        return (GreedyParams) parameters;
    }
    ...
    @Override
    public GreedyPlayer copy() {
        return new GreedyPlayer((GreedyParams) parameters.copy());
    }
}